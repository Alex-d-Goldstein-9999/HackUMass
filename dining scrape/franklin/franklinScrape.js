...
(async () => {
    ...
    await page.goto('https://umassdining.com/locations-menus/franklin/menu'); // Replace with your actual URL
    ...
    fs.writeFileSync('dining scrape/franklin/franklin.json', jsonContent);

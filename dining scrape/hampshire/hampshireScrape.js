...
(async () => {
    ...
    await page.goto('https://umassdining.com/locations-menus/hampshire/menu'); // Replace with your actual URL
    ...
    fs.writeFileSync('dining scrape/hampshire/hampshire.json', jsonContent);

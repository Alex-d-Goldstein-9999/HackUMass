...
(async () => {
    ...
    await page.goto('https://umassdining.com/locations-menus/berkshire/menu'); // Replace with your actual URL
    ...
    fs.writeFileSync('dining scrape/berkshire/berkshire.json', jsonContent);
